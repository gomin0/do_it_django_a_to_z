...
class TestView(TestCase):
    def setUp(self):
        ...
        self.tag_ggmu = Tag.objects.create(name='맨유', slug='맨유')
        self.tag_love = Tag.objects.create(name='좋아요', slug='좋아요')
        ...
        self.post_003.tags.add(self.tag_ggmu)
        self.post_003.tags.add(self.tag_love)
    ...
    def test_post_list(self):
        ...
        self.assertNotIn(self.tag_ggmu.name, post_001_card.text)
        self.assertNotIn(self.tag_love.name, post_001_card.text)
        ...
        self.assertNotIn(self.tag_ggmu.name, post_002_card.text)
        self.assertNotIn(self.tag_love.name, post_002_card.text)
        ...
        self.assertIn(self.tag_ggmu.name, post_003_card.text)
        self.assertIn(self.tag_love.name, post_003_card.text)
    ...
    def test_post_detail(self):
        ...
        self.assertNotIn(self.tag_ggmu.name, post_area.text)
        self.assertNotIn(self.tag_love.name, post_area.text)
    ...
    def test_create_post(self):
        ...
        self.assertEqual(last_post.author.username, 'gomin0')
    ...
    def test_update_post(self):
        ...
        # 로그인은 했지만, 작성자가 아닌 경우
        self.assertNotEqual(self.post_003.author, self.user_gomin1)
        self.client.login(
            username=self.user_gomin1.username,
            password='end981113.'
        )
        response = self.client.get(update_post_url)
        ...
        tag_str_input = main_area.find('input', id='id_tags_str')
        self.assertTrue(tag_str_input)
        self.assertIn('맨유; 좋아요', tag_str_input.attrs['value'])
        ...
        response = self.client.post(
            update_post_url,
            {
                ...
                'category': self.category_soccer.pk,
